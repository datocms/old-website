...
class Support extends React.Component {
  ...
  saveFormToLocalStorage(event) {
    ...
    localStorage.setItem('supportFormValues', JSON.stringify(formValues));
  }

  fillFormFromLocalStorage() {
    const formValues = JSON.parse(localStorage.getItem('supportFormValues'));
    if(formValues) {
  ...
  clearLocalStorageOnSuccess() {
    if(this.formStatus() === 'success') {
      localStorage.removeItem('supportFormValues');
    }
  }
