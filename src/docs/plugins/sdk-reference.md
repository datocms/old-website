...
The SDK exposes the `DatoCmsPlugin.init()` method. This is the main entry-point for all plugin related code. If you require the script from the web without any module system you can include it like this:
...
If you use webpack or browserify, you'll need to require the Plugins SDK.
...
If you have doubts regarding how to structure the logic of your plugin, please take a look at some examples we already made available in our [Github repository](https://github.com/datocms/plugins-sdk/tree/master/examples/).
