    ...
    const opts = attr => ({
      ...
      onCharacterTyped: char => {
        this.setState({
          json: {
            ...this.state.json,
            [attr]: this.state.json[attr] ? this.state.json[attr] + char : char,
          },
        });
      },
    });
          ...
          <div className={wrap()}>
            <div className={b()}>
              <div className={b('col-left')}>
                <Space bottom="2">
                  <h6 className={b('title')}>What your editors see</h6>
                </Space>
                <Browser padded noOverflow title="DatoCMS Editor Interface">
                  ...
                  <div className={b('input')}>
                    {this.state.description && (
                      <Typist {...opts('description')}>A super wizard</Typist>
                    )}
                  </div>
                </Browser>
              </div>
              <div className={b('col-right')}>
                <Space bottom="2">
                  <h6 className={b('title')}>What developers get</h6>
                </Space>
