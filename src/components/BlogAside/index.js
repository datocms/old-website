      ...
      <div className={b()}>
        ...
        <div className={b('cols-aside')}>
          <Sticky top={100} bottomBoundary={`.${b()}`}>
            <div className={b('title')}>DatoCMS Blog</div>
            <div className={b('section')}>
              <div className={b('section-content')}>
                <p>
                  Here we post product updates and publish articles on topics
                  such as digital publishing, content strategy, and software
                  development.
                </p>
                <p>
                  Be sure also to check out our{' '}
                  <Link to="/changelog/">Product Changelog</Link> for more news!
                </p>
              </div>
            </div>
            <div className={b('section')}>
